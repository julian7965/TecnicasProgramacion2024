...
public class FrmJuego extends JFrame {
    ...
    public FrmJuego() {
        ...
        pnlJugador1.setBackground(new Color(0, 35, 245));
        pnlJugador1.setLayout(null);
        pnlJugador2.setBackground(new Color(22, 65, 124));
        pnlJugador2.setLayout(null);

        tpJugadores.setBounds(10, 40, 550, 170);
        tpJugadores.addTab("Julian Tobon", pnlJugador1);
        tpJugadores.addTab("Jose David", pnlJugador2);
    ...
    private void btnRepartirClick(ActionEvent evt) {
        ...
        pnlJugador1.repaint(); SOLO PARA PROBAR QUE REPARTA CARTAS*/
