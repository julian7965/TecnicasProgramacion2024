...
class VistaTabla(object):
    ...
    def ordenar(varClase, arbol, encabezado, descendente):
        ...
        datos = [(arbol.set(nodo, encabezado), nodo) for nodo in arbol.get_children("")]
        ...
        arbol.heading(
            encabezado,
            command=lambda encabezado=encabezado: varClase.ordenar(
                arbol, encabezado, int(not descendente)
            ),
        )
